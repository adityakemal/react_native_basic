...
import { Text, View, FlatList, Modal, SafeAreaView, TouchableWithoutFeedback, Keyboard} from 'react-native';
...
export default function Home({navigation}) {
    ...
    const addForm = (dataForm) =>{
        dataForm.key = Math.random().toString()
        console.log(dataForm, 'hahahah');
        setReview((prevData)=>{
            return [...prevData, dataForm]
        })
        setModal(false)
    }
